...
lagf(paste0(w_data,'wweather.csv'),paste0(r_data,"t_cas_rot.csv"), 
     paste0(w_data,'ab_rot'))
lagf(paste0(w_data,'wweather.csv'),paste0(r_data,"t_cas_inf.csv"), 
     paste0(w_data,'ab_inf'))
lagf(paste0(w_data,'wweather.csv'),paste0(r_data,"t_cas_camp.csv"),
     paste0(w_data,'ab_cam'))
lagf(paste0(w_data,'wweather.csv'),paste0(r_data,"t_cas_borr.csv"),
